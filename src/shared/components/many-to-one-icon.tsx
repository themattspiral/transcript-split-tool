...
export const ManyToOneIcon: React.FC<ManyToOneIconProps> = ({ className, style, width, height = 16 }) => {
  ...
  return (
    <svg width={width} height={height} className={className} style={style} viewBox="0 0 100 64" xmlns="http://www.w3.org/2000/svg">
      ...
      <line x1="17.5" y1="20" x2="38" y2="41" stroke-width="3" stroke="currentColor" marker-end="url(#arrow)" />
      <line x1="50" y1="20" x2="50" y2="40" stroke-width="3" stroke="currentColor" marker-end="url(#arrow)" />
      <line x1="80.5" y1="20" x2="62" y2="41" stroke-width="3" stroke="currentColor" marker-end="url(#arrow)" />
